...
| [`configs/`](configs/) | Модель, tokenizer, корпус, этапы, DeepSpeed |
| [`scripts/`](scripts/) | Сборка корпуса, init, обучение, holdout-eval, QA |
| [`docs/`](docs/) | Философия, ADR, история моделей, runbook V1 |
| [`20B-G/`](20B-G/) | Изолированная ветка ~2B baby-итераций |
